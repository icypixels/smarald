...
function icy_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'					=> 'Icy Social',
			'slug'					=> 'icy-social',
			'source'				=> 'http://smarald.icypixels.com/wp-content/uploads/sites/7/2013/04/icy-social.zip',
			'required'				=> false,
		),
		array(
			'name'					=> 'Icy Portfolio Posts',
			'slug'					=> 'icy-portfolio-posts',
			'source'				=> get_template_directory_uri() . '/includes/icy-portfolio-posts.zip',
			'required'				=> false,			
		),
		array(
